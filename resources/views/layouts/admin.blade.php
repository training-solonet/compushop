...
<body>
    ...
    <!-- jQuery UI -->
	<script src="{{ url('assets/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js') }}"></script>
	<script src="{{ url('assets/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js') }}"></script>

    <!-- jQuery Scrollbar -->
	<script src="{{ url('assets/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js') }}"></script>
...
<!-- Atlantis JS -->
<script src="{{ url('assets/assets/js/atlantis.min.js') }}"></script>
    <script >
