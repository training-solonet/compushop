            ...
            <div class="col-xs-12 col-md-4 ">
                ...
                <div class="contact-info">
                    <div class="footer-logo">
                        <img alt="logo" src="{{ url('style/assets/images/logo-footer.PNG') }}" width="200" height="50" />
                    </div><!-- /.footer-logo -->
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="{{ url('style/assets/images/payments/payment-visa.png') }}"></li>
                        <li><img alt="" src="{{ url('style/assets/images/payments/payment-master.png') }}"></li>
                        <li><img alt="" src="{{ url('style/assets/images/payments/payment-paypal.png') }}"></li>
                        <li><img alt="" src="{{ url('style/assets/images/payments/payment-skrill.png') }}"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
