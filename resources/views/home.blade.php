...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('style/assets/css/colors/green.css') }}">
    ...
    <link href="{{ asset('style/assets/css/colors/blue.css') }}" rel="alternate stylesheet" title="Blue color">
...
<body>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li><a href="category-grid-2.html">Category 2 - Grid/List</a>
                                                        </li>
                        ...
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                                ...
                                <div class="container-fluid">
                                    <div class="caption vertical-center text-left">
                                        <div class="big-text fadeInDown-1">
                                            Save up to a<span class="big"><span
                                                    class="sign">$</span>400</span>
                                        </div>
                            ...
                            <div class="item"
                                ...
                                <div class="container-fluid">
                                    <div class="caption vertical-center text-left">
                                        <div class="big-text fadeInDown-1">
                                            Want a<span class="big"><span
                                                    class="sign">$</span>200</span>Discount?
                                        </div>
                            ...
                            <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                                <div class="product-item">
                                    ...
                                    <div class="body">
                                        <div class="label-discount clear"></div>
                                        <div class="title">
                                            <a href="single-product.html">fitbit zip wireless activity tracker -
                                                lime</a>
                                        </div>
                            ...
                            <div class="gallery-thumbs clearfix">
                                <ul>
                                    <li><a class="horizontal-thumb active"
                                            data-target="#best-seller-single-product-slider" data-slide="0"
                                            href="#slide1"><img alt="" src="assets/images/blank.gif"
                                                data-echo="assets/images/products/gallery-thumb-01.jpg" /></a></li>
    ...
    <script src="{{ asset('style/assets/js/jquery-1.10.2.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/jquery-migrate-1.2.1.js') }}"></script>
    ...
    <script src="{{ asset('style/assets/js/bootstrap-hover-dropdown.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/css_browser_selector.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/echo.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/jquery.easing-1.3.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/bootstrap-slider.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/jquery.raty.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/jquery.prettyPhoto.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/jquery.customSelect.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('style/assets/js/buttons.js') }}"></script>
